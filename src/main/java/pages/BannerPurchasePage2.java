...
public class BannerPurchasePage2 {
    WebDriver driver;

    public BannerPurchasePage2(WebDriver driverLn) {
        {
    ...
    public void PurchaseSmallPackage(String url,String Coupon) throws InterruptedException {
        ...
        Assert.assertEquals( driver.findElement(By.xpath("//*[@id=\"cb-order-total\"]/div[2]")).getText(),"$49.45");
    ...
    public void PurchaseMediumPackage(String url,String Coupon) throws InterruptedException {
        ...
        Assert.assertEquals( driver.findElement(By.xpath("//*[@id=\"cb-order-total\"]/div[2]")).getText(),"$87.25");
    ...
    public void PurchaseLargePackage(String url,String Coupon) throws InterruptedException {
        ...
        Assert.assertEquals( driver.findElement(By.xpath("//*[@id=\"cb-order-total\"]/div[2]")).getText(),"$124.15");
